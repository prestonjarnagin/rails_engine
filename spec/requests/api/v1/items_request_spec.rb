...
RSpec.describe 'Items API' do
  ...
  describe 'Single Finders' do
    ...
    describe 'returns an item given a' do
      it 'id' do
      ...
      it 'unit price' do
        ...
        get "/api/v1/items/find?unit_price=#{expected_price}"
        expect(response).to be_successful
  ...
  describe 'Multi Finders' do
    ...
    describe 'returns an array of items given an' do
      ...
      it 'unit price' do
        expected_price = "%.2f" % Rational("#{@expected_items[0].unit_price}".to_i,100)
        get "/api/v1/items/find_all?unit_price=#{expected_price}"
        expect(response).to be_successful
